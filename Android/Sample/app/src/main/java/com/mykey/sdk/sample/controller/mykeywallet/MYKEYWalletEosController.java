...
public class MYKEYWalletEosController {

    private static final String TAG = "MYKEYSdk";

    private Activity activity;

    public MYKEYWalletEosController(Activity activity) {
    ...
    public void onMyKeyContract() {
        ...
        contractActionRequest.setAccount("hellomykey11")
                .setName("stake")
                .setInfo("info:Execute contract lock 1.0000 ADD")
        ...
        transferActionRequest.setAccount("eosio.token")
                .setName("transfer")
                .setInfo("info:transfer to alicealice11")
