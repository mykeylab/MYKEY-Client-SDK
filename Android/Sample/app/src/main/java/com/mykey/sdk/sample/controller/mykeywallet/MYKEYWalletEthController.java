...
public class MYKEYWalletEthController {
    ...
    public void onMyKeyContract() {
        ...
        contractActionRequest.setAccount("0x084d2D13d6AA6Dfb7F47Dc3c2376839025E022Ee")
                .setName("transfer")
                ...
                // JSON string support, eg:setData("{\"address\":\"0x3BBf0A387a73022A9ebC2491DC4fA8A465C8aAbb\",\"amount\":\"1000000000000000000\"}")
                .setData(new ERC20Entity().setAddress("0x3BBf0A387a73022A9ebC2491DC4fA8A465C8aAbb").setAmount("1000000000000000000"));
//                .setData("{\"_to\":\"0x3BBf0A387a73022A9ebC2491DC4fA8A465C8aAbb\",\"_value\":\"1000000000000000000\"}");
